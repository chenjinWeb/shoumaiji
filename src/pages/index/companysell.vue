    ...
    <div class="content">
      <ul class="tab_label flex" margin-header>
        ...
        <li class="label_list" @click="menuNum = 3" :class="{ 'on': menuNum == 3}">
          按时间
          <div class="triangle_first" v-show="menuNum==3"></div>
        </li>
        <li class="label_list" @click="menuNum = 4" :class="{ 'on': menuNum == 4}">
          按商品
          <div class="triangle_first" v-show="menuNum==4"></div>
        </li>
      </ul>
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        ...
        query:{
          ...
          lchl_area_id:this.$route.query.id
        },
        totalSaleNum:"",
        totalSaleRoom:"",
        keyword:"",
    ...
    methods:{
      ...
      checkorder(id){
        this.$router.push({name:"companyorder",query:{vmId:id,times:this.query.times,timee:this.query.timee}})
      },
      getproductdetail(){
        this.companyselldata_(this.query).then((res)=>{
      ...
      productselllist(){
        const data = {
          ...
          lchl_area_id:this.query.lchl_area_id,
        }
        this.companyselllist_(data).then((res)=>{
          if(res.success==200){
      ...
      productgrouplist(){
        const data = {
          ...
          times:this.query.times,
          timee:this.query.timee,
          lchl_company_id:this.query.lchl_area_id,
        }
        this.companygrouplist_(data).then((res)=>{
          if(res.success==200){
      ...
      producttimelist(){
        ...
        this.companytimelist_(data).then((res)=>{
          if(res.success==200){
