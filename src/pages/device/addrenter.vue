<template>
  ...
  <div class="content-modal">
    <y-header title="添加租赁方" router="-1"></y-header>
    <div class="content">
      <div class="scroll-content" margin-header>
        <ul class="basic_list">
          <li>
            <div class="central_list clear">
              <div class="list_lef fl">租赁方名称</div>
              <div class="list_rig fr">
                <input type="text" placeholder="请输租赁方名称" class="txt" v-model="name">
              </div>
            </div>
          </li>
          <li>
  ...
  export default {
    ...
    methods: {
      ...
      sureadd(){
        ...
        this.addrenterdata_(data).then((res)=>{
          if(res.success==200){
            this.addRenterList(res.data);
            this.$router.go(-1);
          }
        })
      }
