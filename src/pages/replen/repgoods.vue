<template>
  <div class="content-modal">
    ...
    <div class="content">
      ...
      <div class="scroll-content" style="margin-top:0.89rem; margin-bottom: 0.5rem;">
    ...
    methods: {
      ...
      getmonitorInfo() {
        this.monitorInfo_(this.query).then(res => {
          if (res.success == 200) {
            this.monitorInfos = res.data.map( d => { d.num = (d.most-d.surplus_count);return d } );
...
//              this.updateAisles=res.data;
      ...
      pushEdit(){
        ...
        this.tasksubmit_(body).then((res) => {
          if(res.success == 200){
            MessageBox.alert("补货成功!").then(action=>{
              this.$router.go(-1)
            })
          }
        })
